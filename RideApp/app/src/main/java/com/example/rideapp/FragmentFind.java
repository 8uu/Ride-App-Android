...
public class FragmentFind extends Fragment {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!loc_plecare.getText().toString().matches("") && !destinatie.getText().toString().matches("")) {
                    ...
                    selectFilteredRides(adresaPlecare, adresaSosire);

                    RideAdapter rideAdapter = new RideAdapter(getContext(),R.layout.item_layout, lista);
                    listView.setAdapter(rideAdapter);

                } else {
                    Toast.makeText(getContext(), "Completati campurile!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void selectFilteredRides(String locPlecare, String locSosire) {
        new RideService.GetFilteredRides(getContext()) {
            ...
            protected void onPostExecute(List<Ride> rides) {
                ...
                if (rides != null) {
                    ...
                    if(rides.isEmpty())
                    Toast.makeText(getContext(), "Nu s-au gasit rezultate!", Toast.LENGTH_LONG).show();
                }
            }
        }.execute(locPlecare, locSosire);
    }
